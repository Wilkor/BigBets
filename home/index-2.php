  ...
  success: function (data) {
   ...
   getBiglike = data[i].biglike+" Pessoa curtiu";
      ...
      tbody.append(
        ...
        .append($('<td class="text-center" >&nbsp <img title="Curtir"    src="img/like1.png" width="30px" height="30px" style="cursor: pointer;"  onclick="update1('+data[i].bigId+","+1+","+1+","+iduser+');"><br><div class="resultlike" onclick="getPeople('+data[i].bigId+');"  id="'+data[i].bigId+'"><button id="b_transp" data-toggle="tooltip" title="Veja as pessoas que curtiram sua ideia">'+getBiglike+'</button></div></td>'))
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <ul class="nav navbar-nav navbar-right">
          ...
          if($_SESSION["tipo"] =="a"){
            ...
            echo "<li class='page-scroll' active><a href='/Bigbets/Dashboards/index.php'>Dashboards</a></li>";
  ...
  echo    "<div class='modal-body' >";
      ...
      <div id="myModal_like" class="modal fade" role="dialog">
        <div class="modal-dialog" >
          ...
          <div class="modal-body" style="overflow-y: scroll; max-height:30%; " >
  ...
  $.ajax({
   ...
   success: function (data) {
    ...
    for (var i = 0; i <data.length; i++) {
      ...
      document.getElementById("list_like").innerHTML+='<div style="height:10%;width:100%" class="list-group-item "><b>Nome</b>: '+data[i].nome+'<br><b>Área</b>: '+data[i].area+'<b></b><div style="background:#808080;color:#808080;border-radius:50%;-moz-border-radius:50%;height:40%;width:4%"></div></div><br>';
      }else{

      document.getElementById("list_like").innerHTML+='<div style="height:10%;width:100%" class="list-group-item "><b>Nome</b>: '+data[i].nome+'<br><b>Área</b>: '+data[i].area+'<b></b><div style="background:#008000;color:#008000;border-radius:50%;-moz-border-radius:50%;height:40%;width:4%"></div></div><br>';
