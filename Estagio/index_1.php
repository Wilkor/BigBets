...
var tipo = "<?php print $_SESSION["tipo"]; ?>";
   ...
   $projetos = $conn->prepare("select idesta,estagioname,status from estagio where status='s' ");
...
while($result_projeto=$projetos->fetch(PDO::FETCH_ASSOC)){
  ...
  @$dados.="['".$result_projeto['idesta']."','".utf8_encode($result_projeto['estagioname'])."','"
    ...
    function paginar() {
      ...
      for (var i = pagina * tamanhoPagina; i < dados.length && i < (pagina + 1) * tamanhoPagina; i++) {
        ...
        tbody.append(
          ...
          .append($('<td class="hidden-xs">').append(dados[i][0])).append($('</td>'))

          .append($('<td>').append($('<a data-toggle="modal" href="#myModal'+dados[i][0]+'">').append(dados[i][1]))).append($('</a></td>'))
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                  ...
                  echo  "<li class='page-scroll'>
                        <a href='#contact'>Cadastrar Estágios</a>
                    </li>";
                  ...
                  ?>
                    ...
                    <li class="page-scroll">
                        <a href="#portfolio">Consultar Estágios</a>
                    </li>
  ...
  <div> 
    ...
    <section id="contact" style="display: <?php echo $_SESSION['tipo']=="a"?'block':'none'?>">
        <div class="container">
          ...
          <form action="/Bigbets/cadastro/cadastro_estagio.php" method="POST" id="form1">
    ...
    <fieldset>
        ...
        <div class="row">
            ...
            <label for="exampleSelect">Status da Campanha</label>
    ...
    <footer class="text-center">
        ...
        <div class="footer-below">
            <div class="container">
                <div class="row">
                    <div class="col-lg-65">
                        Copyright &copy; Tecnologia 2016
                    </div>
                </div>
            </div>
        </div>
...
var url1="/Bigbets/update/consult_estagio.php?iduser="+iduser+"&idbet="+idbet;
          ...
          $.ajax({
                 ...
                 dataType: 'jsonp',
                       ...
                       success: function (data) {
                                  ...
                                  document.getElementById("form1").action = "/Bigbets/update/update_estagio.php?idbet="+idbet;
