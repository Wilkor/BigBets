    ...
    function paginar() {
      ...
      for (var i = pagina * tamanhoPagina; i < dados.length && i < (pagina + 1) * tamanhoPagina; i++) {
        ...
        tbody.append(
          ...
          .append($('<td  class="text-center">').append(dados[i][0])).append($('</td>'))
    ...
    <fieldset>
        ...
        <div class="row">
            <div class="form-group col-lg-12">
                <label for="exampleInputEmail1">Nome do Estágio</label>
            ...
            <label for="exampleSelect">Status do Estágio</label>
