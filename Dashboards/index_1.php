      ...
      function drawChart() {
        ...
        dataTable.addRows([
         ...
         while($result_timeline=$timeline->fetch(PDO::FETCH_ASSOC)){
          ...
          ",new Date(".$pData1[0].",". $pData1[1].",". $pData1[2].",". $phora1[0].",". $phora1[1].",". $phora1[2].")" .


          ",new Date(".$pData2[0]. ",". $pData2[1].",".$pData2[2].",". $phora2[0].",". $phora2[1].",". $phora2[2].")],";
